...
useradd carlos -m -s /bin/bash -p $(openssl passwd -1 123456) -G GRP_ADM
useradd maria -m -s /bin/bash -p $(openssl passwd -1 123456) -G GRP_ADM
useradd joao -m -s /bin/bash -p $(openssl passwd -1 123456) -G GRP_ADM
...
echo "Permissões de diretórios em execução...."
